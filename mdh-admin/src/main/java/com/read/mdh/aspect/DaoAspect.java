...
import com.read.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* com.read.mdh.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* com.read.mdh.*.dao.*.insert*(..))")
